/**
 * Bio levels for the home page.
 * Each level adds progressively more detail.
 * Use double newlines (\n\n) to separate paragraphs.
 *
 * To add a new level, just add another string to the array.
 * The component will automatically handle any number of levels.
 */
export const bioLevels: string[] = [
	// Level 0: Brief
