...
3. _IMPORTANT_ for all edits to CSS styling, always consider other display sizes (mobile, etc.). If you need more details on specific display sizes to consider, please ask.
